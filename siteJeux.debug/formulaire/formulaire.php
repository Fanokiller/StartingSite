                ...
                <form class="w-full max-w-lg p-10" action="/../siteJeux/formulaire/traitement_ajout.php" method="post" enctype="multipart/form-data">
                    <div class="flex flex-wrap -mx-3 mb-6">
                      ...
                      Nom du jeu
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="J_titre" name="J_titre" type="text" placeholder="League of legend">
                      ...
                      L'editeur
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="J_editeur" name="J_editeur" type="text" placeholder="Riot Games">
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                      ...
                      Type de jeu
                            ...
                            <select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" name="J_type">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-2">
                      ...
                      Jour
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="jour" type="date" placeholder="1">
                        </div>
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
